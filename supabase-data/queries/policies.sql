DROP POLICY "Allow to get countries" ON "public"."countries";
...
DROP POLICY "Allow to get categories" ON "public"."categories";
...
DROP POLICY "Allow users to Insert posts" ON "public"."posts";
...
DROP POLICY "Allow users to select posts" ON "public"."posts";
...
DROP POLICY "Allow users to select comments" ON "public"."comments";
...
DROP POLICY "Allow users to insert comments" ON "public"."comments";
...
DROP POLICY "Allow admin to do all" ON "public"."user_requests";
